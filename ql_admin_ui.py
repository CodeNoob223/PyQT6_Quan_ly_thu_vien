...
class Ui_ql_adminWindow(object):
    def setupUi(self, ql_adminWindow):
        ...
        self.maAdmin_QLineEdit = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.maAdmin_QLineEdit.setGeometry(QtCore.QRect(140, 10, 81, 22))
        self.maAdmin_QLineEdit.setStyleSheet("")
        self.maAdmin_QLineEdit.setText("")
        self.maAdmin_QLineEdit.setReadOnly(True)
        self.maAdmin_QLineEdit.setObjectName("maAdmin_QLineEdit")
