...
class Ui_ql_muonTraWindow(object):
    def setupUi(self, ql_muonTraWindow):
        ...
        self.mathemuon_QLineEdit = QtWidgets.QLineEdit(parent=self.groupBox)
        self.mathemuon_QLineEdit.setGeometry(QtCore.QRect(130, 0, 81, 22))
        self.mathemuon_QLineEdit.setStyleSheet("")
        self.mathemuon_QLineEdit.setText("")
        self.mathemuon_QLineEdit.setReadOnly(True)
        self.mathemuon_QLineEdit.setObjectName("mathemuon_QLineEdit")
        self.label_4.raise_()
        ...
        self.mathemuon_QLineEdit.raise_()
